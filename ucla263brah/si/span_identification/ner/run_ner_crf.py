...
# from transformers import DebertaConfig, DebertaForTokenClassification, DebertaTokenizer
...
def transformers_ner_crf(args):
    ...
    tokenizer = tokenizer_class.from_pretrained(args.config_name if args.config_name else args.model_name_or_path,
    ...
    #                                             do_lower_case=args.do_lower_case,
    #                                             cache_dir=args.cache_dir if args.cache_dir else None)
    bert_model = model_class.from_pretrained(args.config_name,
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            # model = model_class.from_pretrained(checkpoint) # 4later
            model.to(args.device)
